...
public class PublicContainerDiagramSettingsDto
{
    public int SchemaVersion { get; set; }
    public bool Enabled { get; set; }
    public List<PublicContainerDecorationSettingsDto> Decorations { get; set; } = new();
    public List<PublicContainerConnectorSettingsDto> Connectors { get; set; } = new();
}

public class PublicContainerDecorationSettingsDto
{
...
public class PublicContainerConnectorSettingsDto
{
    public string Id { get; set; } = string.Empty;
    public string FromAnchor { get; set; } = "center";
    public string ToAnchor { get; set; } = "center";
