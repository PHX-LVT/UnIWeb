...
public class BlockAppearanceModel
{
...
public class BlockResponsiveOverrideModel
{
...
public class BlockResponsiveSettingsModel
{
    public int SchemaVersion { get; set; }
    public BlockResponsiveOverrideModel? Tablet { get; set; }
    public BlockResponsiveOverrideModel? Mobile { get; set; }
}

public class BlockAnimationSettingsModel
{
    public int SchemaVersion { get; set; }
...
public class ContainerLayoutSettingsModel
{
    public int SchemaVersion { get; set; }
