...
[BsonNoId]
public class ContainerDiagramSettings
{
    public int SchemaVersion { get; set; }
    public bool Enabled { get; set; }
    public List<ContainerDecorationSettings> Decorations { get; set; } = new();
    public List<ContainerConnectorSettings> Connectors { get; set; } = new();
}

[BsonIgnoreExtraElements]
[BsonNoId]
public class ContainerDecorationSettings
{
...
[BsonIgnoreExtraElements]
[BsonNoId]
public class ContainerConnectorSettings
{
    public string Id { get; set; } = string.Empty;
    public string FromAnchor { get; set; } = "center";
    public string ToAnchor { get; set; } = "center";
